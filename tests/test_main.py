"""app.main.generate() teszt: kliens-megszakitas eseten (GeneratorExit) a
reszleges valasz status='partial'-kent naplozodik, es a generator nem probal
ujabb SSE eventet kikuldeni a lezaras utan.
